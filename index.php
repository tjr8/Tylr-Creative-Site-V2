...
<body id="bigWrapper" data-spy="scroll" data-target=".navbar-default" data-offset="100">
    ...
    <section id="text-separator">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h2 data-scroll-reveal="enter left move 10px over 1s after 0.2s">Tyler Robinson</h2>
    ...
    <section id="about">
        ...
        <div class="container">
            ...
            <h1 class="parallaxLetter letter1" data-stellar-ratio="1.5" data-stellar-vertical-offset="0">P</h1>
            <h1 class="parallaxLetter letter2" data-stellar-ratio="0.5" data-stellar-vertical-offset="200">H</h1>
            ...
            <div class="row content">
                ...
                <div class="aboutItem col-md-6 col-sm-6 col-xs-12 clearfix" data-scroll-reveal="enter left move 5px over 1s after 0.6s">
                    ...
                    <div class="aboutText">
                        ...
                        <div class="aboutSeparator"></div>
                        <p>
                            As much as I love art, I equally love technology, especially new technology. With that, it's inevitable that I have a few coding languages under my belt. And I'm more than likely to be learning a new one on a free weekend.
                        </p>
                    </div>
                </div>
                <!--end item-->
                ...
                <div class="aboutItem col-md-6 col-sm-6 col-xs-12 clearfix" data-scroll-reveal="enter right move 5px over 1s after 0.8s">
                    <div class="aboutIconWrapper" data-stellar-ratio="1.05">
                        <i class="fa fa-magic aboutIcon"></i>
                    </div>
                    <div class="aboutText">
                        <h4>Autodidact</h4>
                        <div class="aboutSeparator"></div>
                        <p>
                            I'll forever be an ambitious self-learner. Constantly refining skills and obtaining new ones.
                        </p>
                    </div>
                </div>
                <!--end item-->
            ...
            <h1 class="parallaxLetter letter3" data-stellar-ratio="1.5" data-stellar-vertical-offset="-600">X</h1>
            <h1 class="parallaxLetter letter4" data-stellar-ratio="0.8" data-stellar-vertical-offset="0">N</h1>

            <div class="row">
                <div class="col-md-8" data-scroll-reveal="enter left move over 1s after 0.2s">
                    <h4>Skills</h4>
                ...
                <div class="col-md-4" data-scroll-reveal="enter right move over 1s after 0.4s">

                    <!--progress bar-->
                    <h5>Photoshop</h5>
                    <p>My oldest and dearest friend</p>
                    <br>
                    <!--end progress bar-->
                    ...
                    <!--progress bar-->
                    <h5>HTML/CSS</h5>
                    <p>I've got the basics down</p>
                    <br>
                    <!--end progress bar-->

                    <!--progress bar-->
                    <h5>JavaScript</h5>
                    <p>This is my new smart friend along with jQuery and ReactJS/Redux</p>
                    <br>
                    <!--end progress bar-->

                    <!--progress bar-->
                    <h5>Camera</h5>
                    <p>Who doesn't need some photo skills these days</p>
                    <br>
                    <!--end progress bar-->

                    <!--progress bar-->
                    <h5>Layout/Composition</h5>
                    <p>Aesthetics is my thing</p>
                    <!--end progress bar-->
                </div>
            </div>
    ...
    <section id="portfolio">
        ...
        <div src="pic_mountain.jpg" class="portfolioIntro text-center">
            <a href="#portfolio" data-toggle="tooltip" title="Under Construction">
                <div class="black-overlay"></div>
                <h2 data-scroll-reveal="enter top move 10px over 1s after 0.2s">
                    <span>My Portfolio
                    </span>
                    <p style="margin-top:50px;font-style:italic;font-size:16px;padding:12px;letter-spacing:8px;font-weight:800;">(Under Construction)</p>
                </h2>
            </a>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12 clientsIntro text-center">
                    <h3 data-scroll-reveal="enter left move 10px over 1s after 0.2s"><span>Clients</span></h3>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12" data-scroll-reveal="enter left move over 1s after 0.2s">
                    ...
                    <p class="bold">Feel free to contact me.</p>
                    <p>
                        Send me a message or email anytime. See hours for call availability.
                    </p>

                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 listwrapper">
                            <ul class="infoContact">
                                <li><i class="fa fa-location-arrow"></i> Wenatchee</li>
                                <li>WA 98801</li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 listwrapper">
                            <ul class="infoContact">
                                <li><i class="fa fa-envelope-o"></i> tyler@tylrcreative.com</li>
                            </ul>
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6 listwrapper">
                            <ul class="infoContact">
                                <li><i class="fa fa-clock-o"></i> M-F: 8 AM - 8 PM</li>
                                <li>S-S: 12 PM - 5 PM</li>
                            </ul>
                        </div>
