...
<head>
    ...
    <link href="http://tylrcreative.com/css/bulk-style.css" rel="stylesheet">
...
<body id="bigWrapper" data-spy="scroll" data-target=".navbar-default" data-offset="100">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-right" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a data-scroll href="http://tylrcreative.com/">Home</a></li>
                        <li><a data-scroll href="http://tylrcreative.com/#about">About</a></li>
                        <li class="active"> <a data-scroll href="#portfolio" class="dropdown-toggle" data-toggle="dropdown">Portfolio</a>
                        </li>

                        <li><a data-scroll href="http://tylrcreative.com/#contact">Contact</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Downloads <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a data-scroll href="TylerResume'15.pdf" target="_blank">Resume</a></li>
                            </ul>
                        </li>
    ...
    <section id="portfolio">
        ...
        <div class="gallery js-isotope" data-isotope-options='{ "itemSelector": ".gallery-inner", "masonry": { "columnWidth": ".grid-sizer" } }'>
            ...
            <!--item -->
            <div class="gallery-inner photography">
                <!-- caption -->
                    ...
                    <div class="captionWrapper valign">
                        <a id="trigger-overlay-six" class="overlay-ajax" href="portfolio/single-project-photography.html" data-toggle="modal">
                            <div class="caption-heading">
                                <p>Photography</p>
                                <h4>Lifestyle</h4>
                                <div class="btn btn-default">Coming Soon</div>
                            </div>
                        </a>
                    </div>
                </div>
