            ...
            <div class="container">
                ...
                <div class="content" data-scroll-reveal="enter top move 30px over 1s after 0.2s">
                    ...
                    <div class="singleProjectInfo" data-scroll-reveal="enter right move 30px over 1s after 0.2s" style="text-align: center">
                        ...
                        <span class="bold">2011-2014</span>

                    </div>
                    <!--  end info -->


                    <h2 style="padding-bottom:20px;">Portrait Photography</h2>
                    <div class="galleryList" itemscope itemtype="http://schema.org/ImageGallery">
                    </div>
    ...
    <section id="footer" class="dark">
        <div class="bottomLine text-center">
            ...
            <ul class="footerSocialIcons">
                ...
                <li><a href="https://www.behance.net/tjr"><i class="fa fa-behance fa-2x"></i></a>
                </li>
            </ul>
